...
// @ts-ignore
import { ReactComponent as PhasesSvg } from '../assets/images/phases.svg';
// @ts-ignore
    ...
    <div className='main-page'>
      ...
      <div className='hero-section'>
        <div className='info'>
          <div className='title'>
            INVEST SAFELY <br />
            <span className='green'>INVEST IN QFARM</span>
          </div>
          <div className='description'>
            <b>Fortify</b> your wealth through animal husbandry investing. Start
            investing in hand-selected and professionally managed KZ for as
            little as $100
          </div>
        </div>
        <div className='img'>
      ...
      <img
        style={{ marginBottom: '-5px', marginTop: '200px' }}
        src={line0}
        alt=''
        width={'100%'}
      />
      <div className='block-1'>
        ...
        <div className='info'>
          <div className='text' style={{ zIndex: 10 }}>
            <div className='title'>
              Qfarm - blockchain platform that allows you to invest in animal
              husbandry
            </div>
            <div className='description'>
              <span style={{ color: '#2DC653' }}>
                Build financial freedom for the long term.
              </span>{' '}
              Investing in animal husbandry can give you cash flow, strong
              wealth stability, and diversification. We help you get there.
            </div>
            <button
      ...
      <div className='block-2'>
        ...
        <div className='secondary'>
          QFarm unlocks the potential of real estate for individual investors
          ...
          <div className='card'>
            ...
            >
              ...
              <g clip-path='url(#clip0_351_12)'>
                ...
                />
                <path
                  d='M18.3333 18.3334V36.6667C18.3333 37.6392 18.7196 38.5718 19.4072 39.2594C20.0948 39.9471 21.0275 40.3334 21.9999 40.3334H43.9999C44.9724 40.3334 45.905 39.9471 46.5926 39.2594C47.2803 38.5718 47.6666 37.6392 47.6666 36.6667V18.3334'
                  stroke='white'
                  stroke-width='2.75'
                  stroke-linecap='round'
                  stroke-linejoin='round'
                ...
                />
                <path
                  d='M25.6667 33L31.1667 27.5L34.8334 31.1666L40.3334 25.6666'
                  stroke='white'
                  stroke-width='2.75'
                  stroke-linecap='round'
                  stroke-linejoin='round'
            ...
            <div className='desc'>
              Fractional ownership in high-quality, US real estate. Create your
              account and start building your wealth.
            </div>
            <button
              onClick={() => {
                navigate('/mint');
      ...
      >
        <path
          d='M42 104C42 102.895 42.8954 102 44 102C45.1046 102 46 102.895 46 104L46 140C46 141.105 45.1046 142 44 142C42.8954 142 42 141.105 42 140L42 104Z'
          fill='#47FF4E'
        />
        <path
          d='M46 316C46 317.105 45.1046 318 44 318C42.8954 318 42 317.105 42 316L42 208C42 206.895 42.8954 206 44 206C45.1046 206 46 206.895 46 208L46 316Z'
          fill='url(#paint0_linear_353_14)'
        />
        ...
        <g clip-path='url(#clip0_353_14)'>
          <path
            d='M40 175L42.6667 177.667L48 172.333'
            stroke='white'
            stroke-width='2'
            stroke-linecap='round'
            stroke-linejoin='round'
        ...
        <path
          d='M44.0014 105C43.8348 85.5675 58.2987 51.6851 105.499 51.6851C152.698 51.6851 239.165 51.6851 276.498 51.6851C322.498 51.6851 328 45.9422 328 0.5'
          stroke='url(#paint1_linear_353_14)'
          stroke-width='4'
        />
        <defs>
          <filter
          ...
          >
            ...
            <feGaussianBlur
              stdDeviation='15'
              result='effect1_foregroundBlur_353_14'
            />
          </filter>
          <linearGradient
            id='paint0_linear_353_14'
            x1='44'
            y1='318'
            x2='44'
            y2='206'
      ...
      <div className='block-3'>
        <div className='titles'>
          ...
          <div className='desc'>For investors and owners</div>
        </div>
        <div className='cards'>
          <div className='card'>
            <div className='title'>TOKENIZATION</div>
            <div className='desc'>
              Tokenization removes the <b>middle man</b>, making it easier and
              cheaper for investors to <b>buy/sell.</b>
            </div>
          </div>
          <div className='card'>
            <div className='title'>LOW FEE</div>
            <div className='desc'>
              Investors can <b>trade tokens</b> almost instantly and for a very
              low fee (similar to stock market trades).
            </div>
          </div>
          <div className='card'>
            <div className='title'>CAPITALIZATION</div>
            <div className='desc'>
              For owners makes it <b>possible</b> to raise capital without{' '}
        ...
        <img
          src={figure1}
          alt='figure'
          style={{ position: 'absolute', top: 0, right: '-10vw' }}
        />
      </div>
      <div className='block-4'>
        ...
        <div className='cards'>
          <div className='card'>
            ...
            <div className='title2'>Invest in QFarm</div>
            <div className='desc'>
              A professional farmer from our proven list manages your capital
              and multiplies it
            </div>
          ...
          <div className='card'>
            ...
            <div className='title2'>Wait growth of livestock</div>
            <div className='desc'>
              A professional farmer from our proven list manages your capital
              and multiplies it
            </div>
          ...
          <div className='card'>
            ...
            <div className='title2'>Get profit from investment</div>
            <div className='desc'>
        ...
        <img
          src={Planet}
          alt='Planet'
          style={{ position: 'absolute', right: '-10vw', bottom: -1100 }}
        />
      </div>
      <div className='block-5'>
        ...
        <div className='phases'>
          <p className='active'>PHASE 1</p>

          <p className={phase !== 'first' ? 'active' : ' '}>PHASE 2</p>
        </div>
        <div className='line'>
          <div className='line1'></div>
          <div className='dot1' onClick={() => toggleClass('first')}>
            <div className='inner-dot'></div>
          </div>
          <div className={phase !== 'first' ? 'line1' : 'line2'}></div>
          <div
            className={phase !== 'first' ? 'dot1' : 'dot2'}
            onClick={() => toggleClass('second')}
          >
            <div className='inner-dot'></div>
          </div>
          <div className={phase === 'third' ? 'line1' : 'line3'}></div>
        </div>

        <div className='phases-info'>
          <div className='info'>
            <div className='title active'>DEC 2022</div>
            <div className='desc active'>
              Analyzing Customer Dev. Making a Unique Selling Proposition
              Creating and checking the hypothesis Launching MVP
            </div>
            <div className='card'>
              <p className='title'>PHASE RESULTS</p>
              <p className='desc'>
                Landing page release First token sales Finding product market
                fit
              </p>
            </div>
          </div>
          <div className='info'>
            <div className='title'>FEB 2023</div>
            <div className='desc'>
              Launching a platform for token issuance Legal Structuring of the
              process of registration of farms Providing detailed Farm
              reports/indicators for investors
            </div>
            <div className='card'>
              <p className='title'>PHASE RESULTS</p>
              <p className='desc'>
                Registration of Qfarm Tokens in AIFC jurisdictions Investment
                platforms with increasing payments flow
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='phase-3'>
          <p className={phase === 'third' ? 'active' : ''}>PHASE 3</p>
          <div className='line2'>
            <div className='line1'></div>
            <div
              className={phase === 'third' ? 'dot1' : 'dot2'}
              onClick={() => toggleClass('third')}
            >
              <div className='inner-dot'></div>
            </div>
            <div className={phase === 'third' ? 'line3' : 'line2'}></div>
          </div>
        </div>
        <div className='phases-info' style={{ justifyContent: 'center' }}>
          <div className='info'>
            <div className='title'>JUNE 2023</div>
            <div className='desc'>
              Raising an investment of $200,000 Private offer for loyal
              investors Making public STO
            </div>
            <div className='card'>
              <p className='title'>PHASE RESULTS</p>
              <p className='desc'>Scaling product to the Asian market</p>
            </div>
          </div>
        </div>
      </div>
      <div className='invest-block'>
        <div className='inner'>
          <div className='info'>
            ...
            <p className='desc'>
              Get started with HoneyBricks to see how we can help grow your
              wealth.
            </p>
